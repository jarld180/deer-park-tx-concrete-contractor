  ...
  const navLinks = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { name: 'La Porte', path: '/la-porte' },
        { name: 'Baytown', path: '/baytown' },
        { name: 'Houston', path: '/houston' },
        { name: 'South Houston', path: '/south-houston' }
      ]
    }
  ];
        ...
        <div className="p-8 h-full flex flex-col text-black">
          <div className="flex justify-between items-start mb-12 gap-4">
            <Link to={currentCity ? `/${currentCity}` : "/"} onClick={() => handleLinkClick(currentCity ? `/${currentCity}` : "/")} className="flex items-start space-x-2 min-w-0">
              ...
              <span className="text-xl font-bold uppercase tracking-tighter text-black truncate">Deer Park <span className="text-black">Concrete</span></span>
            </Link>
          ...
          <div className="mt-auto pt-8 border-t border-gray-100">
            ...
            <p className="text-center mt-4 text-black font-bold text-sm">(346) 560-5073</p>
          </div>
        </div>
      </div>
    </>
